				...
				<main id="main-product-list">
						...
						<div id="product-list-OP">
							<div class="product-item-OP col-lg-3" style="padding: 0px;">
								<a href="#" title="">
									...
									<s>2.500.000</s><b> 1.750.000</b><p>-40%</p>
								</a>
								<div>
					...
					<div id="info-OP" class="col-lg-12 col-md-12 col-ms-12 col-12">
						<div>
							...
							<ul>
								<li>- <i>Nhu cầu sử dụng hệ thống thiết bị âm thanh gia đình của bạn: </i>Nhu cầu của bạn là nghe nhạc, karaoke hay dùng để xem phim? Dàn âm thanh nào cũng có thể đáp ứng được cùng lúc cả 3 nhu cầu này, tuy nhiên cần phải lựa chọn kĩ càng nếu bạn đòi hỏi cao hơn.</li>
								<li>- <i>Vị trí đặt hệ thống âm thanh gia đình: </i>Bạn cần ước lượng được không gian đó là rộng hay nhỏ, có kín hay không, vị trí đặt loa có bao phủ được toàn bộ không gian đó hay không để chọn mua số lượng loa cũng như công suất của loa.</li>
								<li>- <i>Sử dụng sản phẩm thương hiệu nào cho thiết bị âm thanh gia đình: </i>Các kiến thức về thương hiệu thiết bị âm thanh sẽ giúp cho bạn an tâm và có thêm kinh nghiệm trong việc lựa chọn hệ thống âm thanh gia đình, cũng như cho bạn có được sự lựa chọn sáng suốt nhất, trán phải mua nhầm hàng kém chất lượng, hàng giả, hàng nhái.</li>
								<li>- <i>Nên tìm hiểu về các thông số kĩ thuật của hệ thống âm thanh: </i>Các thông số kĩ thuật của thiết bị âm thanh sẽ cho bạn biết thông tin chính xác nhất về sản phẩm mà bạn chuẩn bị mua, cũng như giúp bạn có thể tự mình điều chỉnh được hệ thống âm thanh gia đình mình.</li>
							</ul>
						</div>
						<div>
							<p>Những sai lầm mà nhiều người hay mắc phải khi mua các thiết bị hệ thống giải trí tại gia</p>
							<ul>
								<li>- <i>Loa công suất gấp đôi sẽ to gấp đôi: </i>Vì độ lớn của âm thanh còn phụ thuộc vào độ nhạy của loa.</li>
								<li>- <i>Các hệ thống âm thanh đã được tích hợp sẵn những tính năng an toàn: </i>Hiện nay thì hầu hết các hệ thống âm thanh được bán trên thị trường đều có thể phát ra một mức âm cực lớn, có thể gây ảnh hưởng đáng kể đến thính giác của người nghe.</li>
								<li>- <i>Dây loa càng đắt càng tốt: </i>Tín hiệu âm thanh đã qua các đoạn dây nhỏ nối từ bảng mạch hoặc bộ xử lý đến các cổng kết nối. Điều này làm cho chất lượng âm thanh không có sự khác biệt quá lớn ngay cả khi sử dụng dây đắt tiền.</li>
								<li>- <i>Loa càng đắt càng tốt: </i>Có những dàn loa đắt tiền sử dụng kim cương làm màng loa, nhưng chưa hẳn đã có âm sắc trầm ấm và thể hiện âm thanh nhạc cụ cổ điển chân thật như màng loa gỗ.</li>
							</ul>
						</div>
					</div>
				</main>
