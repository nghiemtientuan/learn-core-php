    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body" style="position: relative;">
                <a href="quantri.php?page_layout=themsp" class="btn btn-primary" style="margin: 10px 0 20px 0; position: absolute;">Thêm sản phẩm
                    mới</a>
                <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
                    ...
                    <tr style="height: 300px;">
                        ...
                        <td data-sortable="true">
                            <span class="thumb"><img width="80px" height="150px" src="../img/anh/prd07.png"/></span>

                        </td>
                        <td>
                            <a href="quantri.php?page_layout=suasp"><span><svg class="glyph stroked brush" style="width: 20px;height: 20px;"><use
                    ...
                    <tr style="height: 300px;">
                        ...
                        <td>
                            <a href="#"><span><svg class="glyph stroked brush" style="width: 20px;height: 20px;"><use
                                                xlink:href="#stroked-brush"/></svg></span></a>
                        </td>
