...
if(isset($_POST['submit'])){
    ...
    if(isset($ten_thanhvien)&&isset($mail)&&isset($sdt)&&isset($dia_chi)&&isset($gioi_tinh)&&isset($than_thiet)){
        $sql = "UPDATE thanh_vien SET ho_ten='$ten_thanhvien',mail='$mail',sdt='$sdt',dia_chi'$dia_chi',gioi_tinh'$gioi_tinh',than_thiet='$than_thiet' WHERE id_thanhvien='$id_thanhvien'";
